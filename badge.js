...
/**
 * Class for rendering Bootstrap 4 badge components.
 * @author Rich Lowe
 * @copyright 2018 Rich Lowe
 */
class Badge extends html.Span {
  /**
  ...
  color(arg1) {
    ...
    /** Handle errors */
      ...
      throw new TypeError(`Badge.color(): Invalid signature (${typeof arg1}).`);
  ...
  pill(arg1) {
    ...
    /** Handle errors */
      ...
      throw new TypeError(`Badge.pill(): Invalid signature (${typeof arg1}).`);
