...
/**
 * Class for rendering Bootstrap 4 cards.
 * @author Rich Lowe
 * @copyright 2018 Rich Lowe
 */
class Card extends html.Div {
  /**
  ...
  background(arg1) {
    ...
    /** Handle errors */
      ...
      throw new TypeError(`Card.background(): Invalid signature (${typeof arg1}).`);
  ...
  border(arg1) {
    ...
    /** Handle errors */
      ...
      throw new TypeError(`Card.border(): Invalid signature (${typeof arg1}).`);
  ...
  color(arg1) {
    ...
    /** Handle errors */
      ...
      throw new TypeError(`Card.color(): Invalid signature (${typeof arg1}).`);
