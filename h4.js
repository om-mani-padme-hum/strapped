...
/**
 * Class for rendering Bootstrap 4 rank 4 headings.
 * @author Rich Lowe
 * @copyright 2018 Rich Lowe
 */
class H4 extends html.H4 {
  /**
  ...
  color(arg1) {
    ...
    /** Handle errors */
      ...
      throw new TypeError(`H4.color(): Invalid signature (${typeof arg1}).`);
  ...
  display(arg1) {
    ...
    /** Handle errors */
      ...
      throw new TypeError(`H4.display(): Invalid signature (${typeof arg1}).`);
  ...
  text(arg1) {
    ...
    /** Handle errors */
      ...
      throw new TypeError(`H4.text(): Invalid signature (${typeof arg1}).`);
