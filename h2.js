...
/**
 * Class for rendering Bootstrap 4 rank 2 headings.
 * @author Rich Lowe
 * @copyright 2018 Rich Lowe
 */
class H2 extends html.H2 {
  /**
  ...
  color(arg1) {
    ...
    /** Handle errors */
      ...
      throw new TypeError(`H2.color(): Invalid signature (${typeof arg1}).`);
  ...
  display(arg1) {
    ...
    /** Handle errors */
      ...
      throw new TypeError(`H2.display(): Invalid signature (${typeof arg1}).`);
  ...
  text(arg1) {
    ...
    /** Handle errors */
      ...
      throw new TypeError(`H2.text(): Invalid signature (${typeof arg1}).`);
