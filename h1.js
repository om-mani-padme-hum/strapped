...
/**
 * Class for rendering Bootstrap 4 rank 1 headings.
 * @author Rich Lowe
 * @copyright 2018 Rich Lowe
 */
class H1 extends html.H1 {
  /**
  ...
  color(arg1) {
    ...
    /** Handle errors */
      ...
      throw new TypeError(`H1.color(): Invalid signature (${typeof arg1}).`);
  ...
  display(arg1) {
    ...
    /** Handle errors */
      ...
      throw new TypeError(`H1.display(): Invalid signature (${typeof arg1}).`);
  ...
  text(arg1) {
    ...
    /** Handle errors */
      ...
      throw new TypeError(`H1.text(): Invalid signature (${typeof arg1}).`);
