...
/**
 * Class for rendering Bootstrap 4 card headers.
 * @author Rich Lowe
 * @copyright 2018 Rich Lowe
 */
class CardHeader extends html.Div {
  /**
  ...
  background(arg1) {
    ...
    /** Handle errors */
      ...
      throw new TypeError(`CardHeader.background(): Invalid signature (${typeof arg1}).`);
  ...
  border(arg1) {
    ...
    /** Handle errors */
      ...
      throw new TypeError(`CardHeader.border(): Invalid signature (${typeof arg1}).`);
  ...
  color(arg1) {
    ...
    /** Handle errors */
      ...
      throw new TypeError(`CardHeader.color(): Invalid signature (${typeof arg1}).`);
...
module.exports.CardHeader = CardHeader;
