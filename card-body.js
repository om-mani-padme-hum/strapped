...
/**
 * Class for rendering Bootstrap 4 card bodies.
 * @author Rich Lowe
 * @copyright 2018 Rich Lowe
 */
class CardBody extends html.Div {
  /**
  ...
  background(arg1) {
    ...
    /** Handle errors */
      ...
      throw new TypeError(`CardBody.background(): Invalid signature (${typeof arg1}).`);
  ...
  border(arg1) {
    ...
    /** Handle errors */
      ...
      throw new TypeError(`CardBody.border(): Invalid signature (${typeof arg1}).`);
  ...
  color(arg1) {
    ...
    /** Handle errors */
      ...
      throw new TypeError(`CardBody.color(): Invalid signature (${typeof arg1}).`);
...
module.exports.CardBody = CardBody;
