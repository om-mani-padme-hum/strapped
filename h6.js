...
/**
 * Class for rendering Bootstrap 4 rank 6 headings.
 * @author Rich Lowe
 * @copyright 2018 Rich Lowe
 */
class H6 extends html.H6 {
  /**
  ...
  color(arg1) {
    ...
    /** Handle errors */
      ...
      throw new TypeError(`H6.color(): Invalid signature (${typeof arg1}).`);
  ...
  display(arg1) {
    ...
    /** Handle errors */
      ...
      throw new TypeError(`H6.display(): Invalid signature (${typeof arg1}).`);
  ...
  text(arg1) {
    ...
    /** Handle errors */
      ...
      throw new TypeError(`H6.text(): Invalid signature (${typeof arg1}).`);
