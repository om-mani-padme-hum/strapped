...
/**
 * Class for rendering Bootstrap 4 button checkboxes.
 * @author Rich Lowe
 * @copyright 2018 Rich Lowe
 */
class ButtonCheckbox extends html.Label {
  /**
  ...
  active(arg1) {
    ...
    /** Handle errors */
      ...
      throw new TypeError(`ButtonCheckbox.active(): Invalid signature (${typeof arg1}).`);
  ...
  block(arg1) {
    ...
    /** Handle errors */
      ...
      throw new TypeError(`ButtonCheckbox.block(): Invalid signature (${typeof arg1}).`);
  ...
  color(arg1) {
    ...
    /** Handle errors */
      ...
      throw new TypeError(`ButtonCheckbox.color(): Invalid signature (${typeof arg1}).`);
  ...
  disabled(arg1) {
    ...
    /** Handle errors */
      ...
      throw new TypeError(`ButtonCheckbox.disabled(): Invalid signature (${typeof arg1}).`);
  ...
  name(arg1) {
    ...
    /** Handle errors */
      ...
      throw new TypeError(`ButtonCheckbox.name(): Invalid signature (${typeof arg1}).`);
  ...
  outline(arg1) {
    ...
    /** Handle errors */
      ...
      throw new TypeError(`ButtonCheckbox.outline(): Invalid signature (${typeof arg1}).`);
  ...
  size(arg1) {
    ...
    /** Handle errors */
      ...
      throw new TypeError(`ButtonCheckbox.size(): Invalid signature (${typeof arg1}).`);
  ...
  render(indent) {
    ...
    this.prepend(new html.Input().type('checkbox').checked(this.active()).name(this.name()).autocomplete('off'));
    
    return super.render(indent);
  }
}

module.exports.ButtonCheckbox = ButtonCheckbox;
